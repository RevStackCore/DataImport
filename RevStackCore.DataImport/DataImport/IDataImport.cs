...
namespace RevStackCore.DataImport
{
    ...
    {
        IEnumerable<T> ImportCsv<T>(string filePath, bool hasHeader = true, bool matchCase = false,string replace = null, bool useTabDelimiter = false) where T : class;
        ...
        IEnumerable<T> ImportExcel<T>(string filePath, bool ignoreHeader = false, bool matchCase = false, int worksheetIndex = 1, string replace = null) where T : class;
        IEnumerable<T> ImportExcel<T>(Stream file, bool ignoreHeader = false, bool matchCase = false, int worksheetIndex = 1, string replace = null) where T : class;
        Task<IEnumerable<T>> ImportExcelAsync<T>(string filePath, bool ignoreHeader = false, bool matchCase = false, int worksheetIndex = 1, string replace = null) where T : class;
        Task<IEnumerable<T>> ImportExcelAsync<T>(Stream file, bool ignoreHeader = false, bool matchCase = false, int worksheetIndex=1, string replace = null) where T : class;
